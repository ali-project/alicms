...
<table class="table table-striped table-advance table-hover">
	<thead>
		...
		<th class="tablehead">ct</th>
		<?php
		foreach ($result2 as $r)
		{
			?>
			<th class="tablehead"><?php  echo $r['dbcum'];?></th>
...
?>
      ...
      <td> <a href="javascript:makedo('index.php?m=alicms&f=index&v=deletedata&id=<?php echo $r['id'];?>&dbname=<?php echo $GLOBALS['dbname'];?><?php echo $this->su();?>', '确认删除该记录？')"
